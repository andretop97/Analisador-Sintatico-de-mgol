            ...
            for character in line:  # Passa por todos os símbolos do arquivo um a um
                ...
                if currentState[0] == "Se":
                    ...
                    if character == " " or character == "\n":  # Determinando as condições para para de ler um lexema e registrar ele
                        ...
                        state = initialState
                        lexema = ""
                    elif specialState[0] != "Se" and currentState[
                        1] != "1":  # Permite que seja salvo um lexema logo após outro sem um espaço em branco
                        if state[1] == "id":
                            self.symbleTable.addSymbol(lexema, state[1], "")
                            state = specialState
                            lexema = character
                        ...
                        lexema = ""
                elif state[0] == "s8" or state[
                    0] == "s12":  # O estado descrito aqui adiciona um erro caso a linha termine sem fechar aspas
